...
// NOTE:- Please rename with "CreateClause"

const CreateClauseNew = ({closeEvent, clause}) => {    
    return(
        <>
            ...
            <form>
                <div className="createSection mb-3">  
                    ...
                    <div className='form-group m-0'>
                        <label className='label-control'>Clause Status</label> 
                        <RadioGroup
                            row
...
export default CreateClauseNew;
